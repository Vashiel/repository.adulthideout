...
class Voyeurhit(BaseWebsite):
    def __init__(self, addon_handle):
        super().__init__('voyeurhit', 'https://voyeurhit.com/', 'https://voyeurhit.com/search/{}', addon_handle)
        
        self.label = 'VoyeurHit'
