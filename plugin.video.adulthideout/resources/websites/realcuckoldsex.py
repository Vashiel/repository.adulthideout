...
def process_realcuckoldsex_content(url):
    ...
    add_dir(f'Search realcuckoldsex', 'realcuckoldsex', 5, logos + 'realcuckoldsex.png', fanart)
  
    if "search" not in url and "channels" not in url and "latest-updates" not in url:
