...
class CloudScraper(Session):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.auto_refresh_on_403 = kwargs.pop('auto_refresh_on_403', False)
        self.max_403_retries = kwargs.pop('max_403_retries', 3)
        self._403_retry_count = 0

        # Request throttling and TLS management
        self.last_request_time = 0
        self.min_request_interval = kwargs.pop('min_request_interval', 0.0)
        ...
        self.enable_stealth = kwargs.pop('enable_stealth', False)
    ...
    def create_scraper(cls, sess=None, **kwargs):
        ...
        - enable_stealth: Whether to enable stealth mode (default: False)
        ...
        - auto_refresh_on_403: Whether to automatically refresh session on 403 errors (default: False)
        - max_403_retries: Maximum number of 403 retry attempts (default: 3)
        - min_request_interval: Minimum time in seconds between requests (default: 0.0)
